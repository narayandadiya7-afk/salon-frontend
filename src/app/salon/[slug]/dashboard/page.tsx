    ...
    <div>
      {isExpired && (
        <Alert
          ...
          action={<Link href={`/salon/${slug}/subscription`}><Button type="primary" danger size="small">Renew Now</Button></Link>}
          showIcon
      ...
      {!isExpired && daysLeft <= 7 && (
        <Alert
          ...
          action={<Link href={`/salon/${slug}/subscription`}><Button size="small">Renew Plan</Button></Link>}
          showIcon
          style={{ marginBottom: 24 }}
        />
      )}
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
        {[
          { icon: '✂️', label: 'Add Service', href: `/salon/${slug}/services`, color: '#1890ff' },
          { icon: '📅', label: 'View Bookings', href: `/salon/${slug}/appointments`, color: '#52c41a' },
          { icon: '🕐', label: 'Set Availability', href: `/salon/${slug}/availability`, color: '#fa8c16' },
          { icon: '💳', label: 'Manage Plan', href: `/salon/${slug}/subscription`, color: '#722ed1' },
        ].map((action) => (
      ...
      <Card
        ...
        extra={<Link href={`/salon/${slug}/appointments`}><Button type="link">View All</Button></Link>}
      >
