  ...
  return (
    <>
      <PageHeader
        ...
        actions={<Button variant="gold"><Plug className="size-4" /> Add integration</Button>}
      />
        ...
        {integrations.map((i) => (
          <div key={i.name} className="surface-card flex flex-col p-5 transition-shadow hover:shadow-[var(--shadow-elevated)]">
            ...
            <div className="mt-4 flex gap-2">
              ...
              <Button variant="secondary" size="sm" className="flex-1">Logs</Button>
            </div>
          </div>
        ))}
      </div>

      <Panel className="mt-8" title="API access" description="Platform REST and webhook endpoints">
