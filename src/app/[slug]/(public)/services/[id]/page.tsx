...
const services = [
  ...
  { id: '3', category: 'Skin', name: 'Luxury Facial', desc: 'Deep-cleansing facial with premium organic products tailored to your skin type. Our estheticians use a multi-step approach to cleanse, exfoliate, extract, and hydrate for radiant results.', duration: '75 min', price: '₹3,200', rating: 4.9, reviews: 214, image: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=800&q=80', benefits: ['Deep cleansing', 'Exfoliation', 'Extraction', 'Hydrating mask', 'Face & neck massage'], included: ['Skin analysis', 'Double cleanse', 'Steam & extraction', 'Mask & massage', 'SPF application'], staff: ['Ananya Patel', 'Maya Krishnan'], faqs: [{ q: 'How often should I get a facial?', a: 'For best results, we recommend a facial every 4-6 weeks to maintain healthy, glowing skin.' }] },
