...
const teamMembers = [
  { id: '1', name: 'Priya Sharma', role: 'Master Stylist & Founder', experience: '12 years', bio: 'Priya is the visionary behind LuxeStudio. Trained in Paris and Milan, she brings international expertise and a passion for precision cutting. Her work has been featured in Vogue India and Harper\'s Bazaar.', specialties: ['Hair Cutting', 'Color', 'Bridal', 'Editorial'], rating: 4.9, reviews: 412, image: 'https://images.unsplash.com/photo-1580618672591-eb180b1a973f?w=400&q=80', languages: ['English', 'Hindi', 'French'], instagram: '@priyasharma' },
  { id: '2', name: 'Ananya Patel', role: 'Lead Esthetician', experience: '8 years', bio: 'Ananya specializes in advanced skincare treatments. Certified in chemical peels and microdermabrasion, she creates personalized skincare regimens that deliver visible results.', specialties: ['Facials', 'Chemical Peel', 'Microdermabrasion', 'Skin Analysis'], rating: 4.8, reviews: 289, image: 'https://images.unsplash.com/photo-1598346762291-aee88549193f?w=400&q=80', languages: ['English', 'Hindi', 'Kannada'], instagram: '@ananya.skin' },
  { id: '3', name: 'Rohit Verma', role: 'Master Barber', experience: '15 years', bio: 'With 15 years of experience, Rohit is a master of classic and contemporary barbering. His precision fades and traditional straight-razor shaves have made him a favorite among our clientele.', specialties: ['Classic Cuts', 'Beard Styling', 'Straight Razor', 'Hot Towel Shave'], rating: 4.9, reviews: 534, image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80', languages: ['English', 'Hindi'], instagram: '@rohitbarber' },
  { id: '4', name: 'Maya Krishnan', role: 'Nail Artist', experience: '6 years', bio: 'Maya is an award-winning nail artist known for her intricate designs and attention to detail. She specializes in gel extensions, nail art, and paraffin treatments.', specialties: ['Nail Art', 'Gel Extensions', 'Paraffin', '3D Design'], rating: 4.7, reviews: 198, image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&q=80', languages: ['English', 'Tamil', 'Kannada'], instagram: '@maya.nails' },
  { id: '5', name: 'Vikram Singh', role: 'Hair Color Specialist', experience: '10 years', bio: 'Vikram is a certified L\'Oréal Professionnel colorist. He creates stunning color transformations using advanced techniques like balayage, ombre, and foiling.', specialties: ['Balayage', 'Ombre', 'Color Correction', 'Highlights'], rating: 4.8, reviews: 267, image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&q=80', languages: ['English', 'Hindi'], instagram: '@vikramcolor' },
  { id: '6', name: 'Sophia D\'Souza', role: 'Makeup Artist', experience: '9 years', bio: 'Sophia is a celebrity makeup artist with experience in film and fashion. She specializes in bridal and editorial makeup using premium brands like MAC, Charlotte Tilbury, and NARS.', specialties: ['Bridal', 'Editorial', 'Airbrush', 'Special Effects'], rating: 4.9, reviews: 178, image: 'https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?w=400&q=80', languages: ['English', 'Hindi', 'Konkani'], instagram: '@sophiamakeup' },
];
